<template>
  <div class="container">
    <div style="height: 100px; background-color: white">
      <div style="width: 100%; height: 100%; display: flex; align-items: center; margin:  0 auto">
        <img src="@/assets/imgs/logo.png" alt="" style="width: 50px">
        <span style="color: #2A60C9; font-size: 24px; font-weight: bold; margin-left: 10px">智慧养老平台</span>
      </div>
    </div>
    <div style="height: calc(100vh - 250px); width: 70%; margin:  0 auto; display: flex; align-items: center">
      ...
      <div style="width: 400px; height: 460px ;padding: 50px 40px; box-shadow:  0 0 10px rgba(0, 0, 0 ,.1); background-color: white; border-radius: 5px;">
        ...
        <div style="text-align: center; font-size: 22px; margin-bottom: 50px; font-weight: bold; color: #2A60C9">欢 迎 注 册</div>
