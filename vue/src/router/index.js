...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'activity0', name: 'Activity0', meta: { name: '公益活动0' }, component: () => import('../views/manager/Activity0') },
      // { path: 'activity1', name: 'Activity1', meta: { name: '公益活动1' }, component: () => import('../views/manager/Activity1') },
